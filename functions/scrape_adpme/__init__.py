"""Azure Function – Scraping quotidien ADPME."""
...
def main(mytimer: func.TimerRequest) -> None:
    logging.info("Azure Function: Scraping ADPME démarré")

    scraper = ADPMEScraper()
    publications = scraper.run()

    logging.info(f"ADPME: {len(publications)} publications trouvées")
