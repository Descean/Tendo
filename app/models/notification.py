...
class Notification(Base):
    ...
    __table_args__ = (
        UniqueConstraint("user_id", "publication_id", "channel", name="uq_user_pub_channel"),
    )
    ...
    def __repr__(self) -> str:
        return f"<Notification(id={self.id}, user={self.user_id}, pub={self.publication_id}, ch={self.channel})>"
